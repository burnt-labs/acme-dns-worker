/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d8774af94a3839f4c6b1586963e4b2a0)
// Runtime types generated with workerd@1.20260128.0 2025-11-15 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
	}
	interface ProductionEnv {
		ALLOWED_DOMAINS: "rpc.xion-testnet-2.burnt.com,api.xion-testnet-2.burnt.com,rpc.xion-mainnet-1.burnt.com,api.xion-mainnet-1.burnt.com";
		API_KEYS: string;
		CF_API_TOKEN: string;
		CF_ZONE_ID: string;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_DOMAINS" | "API_KEYS" | "CF_API_TOKEN" | "CF_ZONE_ID">> {}
}
